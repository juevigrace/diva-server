...
func NewHandlerModule(services *ServiceModule, files *filehelper.FileHelper) *HandlerModule {
	...
	userProfile := handler.NewUserProfileHandler(services.UserPermission, services.UserProfile, files)
