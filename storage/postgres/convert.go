...
func DivaUserFromStorage(src storage.DivaUser) pg.DivaUser {
	var deletedAt pgtype.Timestamptz
	if src.DeletedAt != nil {
		deletedAt = pgtype.Timestamptz{Time: time.UnixMilli(*src.DeletedAt), Valid: true}
	}
	return pg.DivaUser{
		...
		CreatedAt:    pgtype.Timestamptz{Time: time.UnixMilli(src.CreatedAt), Valid: true},
		UpdatedAt:    pgtype.Timestamptz{Time: time.UnixMilli(src.UpdatedAt), Valid: true},
		DeletedAt:    deletedAt,
	}
}
...
func DivaPermissionFromStorage(src storage.DivaPermission) pg.DivaPermission {
	var deletedAt pgtype.Timestamptz
	if src.DeletedAt != nil {
		deletedAt = pgtype.Timestamptz{Time: time.UnixMilli(*src.DeletedAt), Valid: true}
	}
	return pg.DivaPermission{
		ID:          pgtype.UUID{Bytes: src.ID, Valid: true},
		Name:        src.Name,
		Description: src.Description,
		Action:      src.Action,
...
func DivaSessionFromStorage(src storage.DivaSession) pg.DivaSession {
	return pg.DivaSession{
		ID:           pgtype.UUID{Bytes: src.ID, Valid: true},
...
func DivaUserStateFromStorage(src storage.DivaUserState) pg.DivaUserState {
	return pg.DivaUserState{
		UserID:       pgtype.UUID{Bytes: src.UserID, Valid: true},
		Verified:     src.Verified,
		Status:       pg.UserStatusType(src.Status),
		LastActiveAt: pgtype.Timestamptz{Time: time.UnixMilli(src.LastActiveAt), Valid: true},
		UpdatedAt:    pgtype.Timestamptz{Time: time.UnixMilli(src.UpdatedAt), Valid: true},
	}
}
...
func DivaUserProfileFromStorage(src storage.DivaUserProfile) pg.DivaUserProfile {
...
func DivaUserPreferenceFromStorage(src storage.DivaUserPreference) pg.DivaUserPreference {
	return pg.DivaUserPreference{
		ID:                  pgtype.UUID{Bytes: src.ID, Valid: true},
		UserID:              pgtype.UUID{Bytes: src.UserID, Valid: true},
		Device:              src.Device,
		...
		OnboardingCompleted: src.OnboardingCompleted,
		Language:            src.Language,
		LastSyncAt:          pgtype.Timestamptz{Time: time.UnixMilli(src.LastSyncAt), Valid: true},
		CreatedAt:           pgtype.Timestamptz{Time: time.UnixMilli(src.CreatedAt), Valid: true},
		UpdatedAt:           pgtype.Timestamptz{Time: time.UnixMilli(src.UpdatedAt), Valid: true},
	}
}
...
func DivaUserPermissionFromStorage(src storage.DivaUserPermission) pg.DivaUserPermission {
	...
	return pg.DivaUserPermission{
		PermissionID: pgtype.UUID{Bytes: src.PermissionID, Valid: true},
		UserID:       pgtype.UUID{Bytes: src.UserID, Valid: true},
		GrantedBy:    grantedBy,
		Granted:      src.Granted,
		GrantedAt:    pgtype.Timestamptz{Time: time.UnixMilli(src.GrantedAt), Valid: true},
		ExpiresAt:    expiresAt,
		UpdatedAt:    pgtype.Timestamptz{Time: time.UnixMilli(src.UpdatedAt), Valid: true},
	}
}
...
func DivaActionFromStorage(src storage.DivaAction) pg.DivaAction {
	return pg.DivaAction{
		ID:     pgtype.UUID{Bytes: src.ID, Valid: true},
		Name:   src.Name,
		UserID: pgtype.UUID{Bytes: src.UserID, Valid: true},
	}
...
func DivaActionVerificationFromStorage(src storage.DivaActionVerification) pg.GetUserVerificationRow {
	var usedAt pgtype.Timestamptz
	if src.UsedAt != nil {
		usedAt = pgtype.Timestamptz{Time: time.UnixMilli(*src.UsedAt), Valid: true}
	}
	return pg.GetUserVerificationRow{
